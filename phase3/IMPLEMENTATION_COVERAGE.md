...
| --- | --- | --- | --- | --- | --- | --- |
| table | AgeGroup | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/age_group.view.lkml; phase3/warehouse_sql/01_seed_age_group.sql | Business table |
| table | BU | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/bu.view.lkml; phase3/warehouse_sql/07_dim_bu.sql | Business table |
| table | Date | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml; phase3/warehouse_sql/08_dim_date.sql | Business table |
...
| table | Employee | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml; phase3/warehouse_sql/09_fact_employee.sql | Business table |
| table | Ethnicity | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/ethnicity.view.lkml; phase3/warehouse_sql/03_seed_ethnicity.sql | Business table |
| table | FP | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/fp.view.lkml; phase3/warehouse_sql/04_dim_fp.sql | Business table |
| table | Gender | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/gender.view.lkml; phase3/warehouse_sql/02_seed_gender.sql | Business table |
...
| table | PayType | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/pay_type.view.lkml; phase3/warehouse_sql/05_dim_pay_type.sql | Business table |
| table | SeparationReason | LookML view + warehouse | IMPLEMENTED | IMPLEMENTED | phase3/views/separation_reason.view.lkml; phase3/warehouse_sql/06_dim_separation_reason.sql | Business table |
| column | AgeGroup.AgeGroupID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/age_group.view.lkml | Source column |
| column | AgeGroup.AgeGroup | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/age_group.view.lkml | Source column |
| column | BU.BU | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/bu.view.lkml | Source column |
| column | BU.RegionSeq | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/bu.view.lkml | Source column |
| column | BU.VP | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/bu.view.lkml | Source column |
| column | Date.Date | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.Month | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.MonthNumber | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.Period | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.PeriodNumber | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.Qtr | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.QtrNumber | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.Year | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.Day | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.MonthStartDate | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
| column | Date.MonthEndDate | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | Source column |
...
| column | Employee.date | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.EmplID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.Gender | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.Age | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.EthnicGroup | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.FP | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.TermDate | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.BU | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.HireDate | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.PayTypeID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Employee.TermReason | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | Source column |
| column | Ethnicity.Ethnic Group | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/ethnicity.view.lkml | Source column |
| column | Ethnicity.Ethnicity | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/ethnicity.view.lkml | Source column |
| column | FP.FP | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/fp.view.lkml | Source column |
| column | FP.FPDesc | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/fp.view.lkml | Source column |
| column | Gender.ID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/gender.view.lkml | Source column |
| column | Gender.Gender | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/gender.view.lkml | Source column |
| column | Gender.Sort | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/gender.view.lkml | Source column |
...
| column | PayType.PayTypeID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/pay_type.view.lkml | Source column |
| column | PayType.PayType | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/pay_type.view.lkml | Source column |
| column | SeparationReason.SeparationTypeID | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/separation_reason.view.lkml | Source column |
| column | SeparationReason.SeparationReason | LookML dimension | IMPLEMENTED | IMPLEMENTED | phase3/views/separation_reason.view.lkml | Source column |
| measure | Employee.EmpCount | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.Seps | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.Actives | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.New Hires | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.AVG Tenure Days | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.AVG Tenure Months | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.AVG Age | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.Sum of BadHires | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.New Hires SPLY | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.Actives SPLY | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.Seps SPLY | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.EmpCount SPLY | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.Seps YoY Var | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Actives YoY Var | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.New Hires YoY Var | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Seps YoY % Change | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Actives YoY % Change | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.New Hires YoY % Change | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Bad Hires SPLY | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.Bad Hires YoY Var | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Bad Hires YoY % Change | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.TO % | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.TO % Norm | LookML measure | TODO | TODO | phase3/views/employee.view.lkml | COMPLEX DAX stubbed with NULL or partial; parity required |
| measure | Employee.TO % Var | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.Sep%ofActive | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.Sep%ofSMLYActives | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | Employee.BadHire%ofActives | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/employee.view.lkml | LookML measure present |
| measure | Employee.BadHire%ofActiveSPLY | LookML measure | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | Implemented formula but depends on TODO parents or EmpCount nesting gap |
| measure | BU.Count of BU | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/bu.view.lkml | LookML measure present |
| measure | Date.Count of Date | LookML measure | IMPLEMENTED | IMPLEMENTED | phase3/views/date.view.lkml | LookML measure present |
| calculated_column | BU.Region | Warehouse + LookML | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/07_dim_bu.sql; phase3/views/bu.view.lkml | SUBSTR RegionSeq |
| calculated_column | Date.MonthIncrementNumber | Warehouse SQL | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/08_dim_date.sql; phase3/views/date.view.lkml | Materialized in date SQL |
| calculated_column | Employee.isNewHire | Warehouse column + LookML dim | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/09_fact_employee.sql; phase3/views/employee.view.lkml | Materialized on fact |
| calculated_column | Employee.AgeGroupID | Warehouse column + LookML dim | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/09_fact_employee.sql; phase3/views/employee.view.lkml | Materialized on fact |
| calculated_column | Employee.TenureDays | Warehouse column + LookML dim | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/09_fact_employee.sql; phase3/views/employee.view.lkml | Materialized on fact |
| calculated_column | Employee.TenureMonths | Warehouse column + LookML dim | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/09_fact_employee.sql; phase3/views/employee.view.lkml | Materialized on fact |
| calculated_column | Employee.BadHires | Warehouse column + LookML dim | IMPLEMENTED | IMPLEMENTED | phase3/warehouse_sql/09_fact_employee.sql; phase3/views/employee.view.lkml | Materialized on fact |
...
| relationship | Employee.date->Date.Date | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.FP->FP.FP | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.EthnicGroup->Ethnicity.Ethnic Group | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.Gender->Gender.ID | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.PayTypeID->PayType.PayTypeID | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.BU->BU.BU | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.AgeGroupID->AgeGroup.AgeGroupID | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| relationship | Employee.TermReason->SeparationReason.SeparationTypeID | LookML join | IMPLEMENTED | IMPLEMENTED | phase3/models/human_resources.model.lkml | M:1 Single |
| power_query | BU | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/07_dim_bu.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | FP | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/04_dim_fp.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | PayType | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/05_dim_pay_type.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | SeparationReason | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/06_dim_separation_reason.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | Date | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/08_dim_date.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | Employee | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/09_fact_employee.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | Ethnicity | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/03_seed_ethnicity.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | Gender | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/02_seed_gender.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| power_query | AgeGroup | Warehouse SQL/Seed | IMPLEMENTED | PARTIAL | phase3/warehouse_sql/01_seed_age_group.sql | Template SQL — SOURCE_DATASET placeholders; not executed/validated |
| hierarchy | Date.YQM | drill_fields / set | PARTIAL | PARTIAL | phase3/views/date.view.lkml (yqm_drill) | YQM approximated; not PBI UI |
...
| partitions | 122 partitions | Warehouse refresh consideration | PARTIAL | PARTIAL | phase3/warehouse_sql/README.md | LookML has no partition object; documented in mapping §10 |
...
| format | Date.Date | value_format_name | PARTIAL | PARTIAL | phase3/views/date.view.lkml | PBI format=General Date |
| format | Date.MonthStartDate | value_format_name | PARTIAL | PARTIAL | phase3/views/date.view.lkml | PBI format=General Date |
| format | Date.MonthEndDate | value_format_name | PARTIAL | PARTIAL | phase3/views/date.view.lkml | PBI format=General Date |
| format | Employee.date | value_format_name | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | PBI format=General Date |
| format | Employee.TermDate | value_format_name | PARTIAL | PARTIAL | phase3/views/employee.view.lkml | PBI format=General Date |
